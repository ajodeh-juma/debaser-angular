 ...
 // 3. Add that value to submissions
    ...
    //organism: this.selectedOrg,
	  ...
	  if (data.varieties.length == 1) {
	    this.checkFor="http://127.0.0.1:8000/media/results-geneids/"+this.uid+"_consensuslink.html";
	  }
	  else {
	    this.checkFor="http://127.0.0.1:8000/media/multi-results-ids/"+this.uid+"_links.html";
	  }
